		...
		$this->startControlsSection(
			...
			$this->addControl(
	            ...
	            array(
	                ...
	                'default' => '',
	                'selectors' => array(
	                    '{{WRAPPER}} .pos-title-4 .under-title .title-through-line' => 'border-color: {{VALUE}};', 
	                ),
	            )
	        );
			$this->addResponsiveControl(
				...
				array(
					...
					'selectors' => array(
						'{{WRAPPER}} .pos-title-4 .under-title .title-through-line' => 'width: {{SIZE}}{{UNIT}};',
					),
				)
			);
			$this->addResponsiveControl(
				...
				array(
					...
					'selectors' => array(
						'{{WRAPPER}} .pos-title-4 .under-title .title-through-line' => 'margin-top: {{SIZE}}{{UNIT}};',
					),
				)
			);
		$this->endControlsSection();
	...
	protected function render() {
		...
		$html .= '<div class="pos-title-widget pos-title-'. $settings['design'] .'">';
			...
			if($settings['design'] == 4){
				$html .= '<div class="under-title"><span class="title-through-line"></span></div>';
			}
		$html .= '</div>';

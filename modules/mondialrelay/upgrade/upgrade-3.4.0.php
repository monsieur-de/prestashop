...
function upgrade_module_3_4_0($module)
{
    ...
    if (!array_search('delivery_mode', array_column($describeMethodColumns, 'Field'))) {
        $sql = 'ALTER TABLE `' . _DB_PREFIX_ . 'mondialrelay_carrier_method` CHANGE `delivery_mode` `delivery_mode` ENUM(\'24R\',\'APM\',\'MED\',\'HOM\') NOT NULL';

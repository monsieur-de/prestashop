...
{
    /**
     * @var string $logsDir The logs' directory.
     */
    private $logsDir;

    /**
     * @var string $logsFile The logs file.
     */
    private $logsFile;
    ...
    private function addArrayToLogsFile(array $array, $tabLevel = 1)
    {
        foreach ($array as $key => $value) {
            ...
            if (is_array($value)) {
                $this->addLog($this->getTabLevel($tabLevel) . $key . ' => array(');
     ...
     * @return null|string The tabulation level.
     */

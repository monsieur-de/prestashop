...
class appAppKernelProdContainer extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('FX5gqEQ8-K', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $h = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($d, [0 => (\dirname(__DIR__, 4).'/modules/ps_accounts/src/Entity')]);
        $h->addExcludePaths([0 => (\dirname(__DIR__, 4).'/modules/ps_accounts/src/Entity/index.php')]);
    ...
    {
        return $this->privates['api_platform.cache.identifiers_extractor'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('krLGaXE+KK', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.property'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('a+6P4RquK1', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.property.legacy'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('SSKdm9VyRJ', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('1cDTht+3UV', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource.legacy'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('slYkI3iQ0g', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource_collection'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('iJhNLyRK6K', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.route_name_resolver'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('naGwoN3-xr', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.subresource_operation_factory'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('1KTK-Hn9M8', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('KA4M4IToUO', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.property_access'] = \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('AriT9eh8H9', 0, $this->getParameter('container.build_id'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.property_info'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('U7HglQqX6J', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('viZXat29L4', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.serializer'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('EAsCj-ef-+', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.validator'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('1bGqzQE37F', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'modules_translation_paths' => [
                ...
                22 => (\dirname(__DIR__, 4).'/modules/statsbestmanufacturers/translations'),
                23 => (\dirname(__DIR__, 4).'/modules/statsbestvouchers/translations'),
                24 => (\dirname(__DIR__, 4).'/modules/ps_crossselling/translations'),
                25 => (\dirname(__DIR__, 4).'/modules/klaviyopsautomation/translations'),
                26 => (\dirname(__DIR__, 4).'/modules/statspersonalinfos/translations'),
                27 => (\dirname(__DIR__, 4).'/modules/psassistant/translations'),
                28 => (\dirname(__DIR__, 4).'/modules/psshipping/translations'),
                29 => (\dirname(__DIR__, 4).'/modules/statsbestcustomers/translations'),
                30 => (\dirname(__DIR__, 4).'/modules/statscarrier/translations'),
                ...
                34 => (\dirname(__DIR__, 4).'/modules/gamification/translations'),
                35 => (\dirname(__DIR__, 4).'/modules/statsregistrations/translations'),
                ...
                42 => (\dirname(__DIR__, 4).'/modules/ps_edition_basic/translations'),
                43 => (\dirname(__DIR__, 4).'/modules/ps_categoryproducts/translations'),
                ...
                55 => (\dirname(__DIR__, 4).'/modules/statscheckup/translations'),
                56 => (\dirname(__DIR__, 4).'/modules/ps_brandlist/translations'),
                57 => (\dirname(__DIR__, 4).'/modules/statsdata/translations'),
                58 => (\dirname(__DIR__, 4).'/modules/ps_checkpayment/translations'),
                59 => (\dirname(__DIR__, 4).'/modules/ps_emailalerts/translations'),
                60 => (\dirname(__DIR__, 4).'/modules/psxmarketingwithgoogle/translations'),
                61 => (\dirname(__DIR__, 4).'/modules/dashgoals/translations'),
                62 => (\dirname(__DIR__, 4).'/modules/gsitemap/translations'),
                63 => (\dirname(__DIR__, 4).'/modules/pagesnotfound/translations'),
                64 => (\dirname(__DIR__, 4).'/modules/ps_cashondelivery/translations'),
                65 => (\dirname(__DIR__, 4).'/modules/statsbestcategories/translations'),
                66 => (\dirname(__DIR__, 4).'/modules/psxdesign/translations'),
                67 => (\dirname(__DIR__, 4).'/modules/ps_accounts/translations'),
                68 => (\dirname(__DIR__, 4).'/modules/ps_mbo/translations'),
                69 => (\dirname(__DIR__, 4).'/modules/ps_themecusto/translations'),
                70 => (\dirname(__DIR__, 4).'/modules/ps_wirepayment/translations'),
                71 => (\dirname(__DIR__, 4).'/modules/pscartdropdown/translations'),
                72 => (\dirname(__DIR__, 4).'/modules/paypal/translations'),
                73 => (\dirname(__DIR__, 4).'/modules/mondialrelay/translations'),
            ],

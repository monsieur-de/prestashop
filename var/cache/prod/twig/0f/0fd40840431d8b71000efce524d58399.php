...
class __TwigTemplate_252cdf6a83eea909055131d6466d4b19 extends Template
{
    private $source;
    private $macros = [];
...
array_key_exists("origin", $context)) ? (_twig_default_filter(($context["origin"] ?? null), "none")) : ("none"))]));
    ...
    {
        return new Source("", "@PrestaShop/Admin/Module/Includes/grid_notification_configure.html.twig", "C:\\Users\\nihmo\\prestashop\\src\\PrestaShopBundle\\Resources\\views\\Admin\\Module\\Includes\\grid_notification_configure.html.twig");
    }
}

...
class __TwigTemplate_cdb122f2358a09b9ee56a9ad2f91fed3 extends Template
{
    private $source;
    private $macros = [];
...
array_key_exists("origin", $context)) ? (_twig_default_filter(($context["origin"] ?? null), "none")) : ("none"))]));
    ...
    {
        return new Source("", "@PrestaShop/Admin/Module/Includes/grid_notification_update.html.twig", "C:\\Users\\nihmo\\prestashop\\src\\PrestaShopBundle\\Resources\\views\\Admin\\Module\\Includes\\grid_notification_update.html.twig");
    }
}

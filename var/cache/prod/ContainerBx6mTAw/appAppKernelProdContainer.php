...
class appAppKernelProdContainer extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('DBRWsSoha9', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = (new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))->createConnection(['driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => '', 'dbname' => 'prestashop_db', 'user' => 'root', 'password' => '', 'charset' => 'utf8mb4', 'driverOptions' => [1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))', 1013 => $this->getEnv('const:runtime:_PS_ALLOW_MULTI_STATEMENTS_QUERIES_')], 'defaultTableOptions' => []], new \Doctrine\DBAL\Configuration(), $a, ['enum' => 'string']);
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $e = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($d, [0 => (\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'modules'.\DIRECTORY_SEPARATOR.'psxdesign'.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Entity')]);
    ...
    {
        return $this->privates['api_platform.cache.identifiers_extractor'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('m5511qIl8L', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.property'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('FZ6AnL4MsS', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.property.legacy'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('GrxU1--z1z', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('FV+4-HVtKE', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource.legacy'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('MQb+lhUTnG', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource_collection'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('OzW4ZxFStm', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.route_name_resolver'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('QdvoMOlZ0b', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.subresource_operation_factory'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('QmTGAfwvcD', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('lJDACaeRHi', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.property_access'] = \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('7DXiF5jimf', 0, $this->getParameter('container.build_id'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.property_info'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('kiZt4L5i8K', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('TCbo6yKS1T', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.serializer'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('e2qwXzx4nZ', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.validator'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('99ShZqeOUj', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(($this->privates['uri_signer'] ?? ($this->privates['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('L6PgJBEp0XFb4JLnzeFTSaOboymNq8E6D8BOzs4DD4amwLimwj9CqbEP58k6hLzE'))), '/_fragment');
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'secret' => 'L6PgJBEp0XFb4JLnzeFTSaOboymNq8E6D8BOzs4DD4amwLimwj9CqbEP58k6hLzE',
            'ps_caching' => 'CacheMemcache',
            'ps_cache_enable' => false,
            'ps_creation_date' => '2024-09-26',
            'locale' => 'fr-FR',
            ...
            'modules_translation_paths' => [
                ...
                7 => (\dirname(__DIR__, 4).'/modules/ps_specials/translations'),
                8 => (\dirname(__DIR__, 4).'/modules/ps_newproducts/translations'),
                9 => (\dirname(__DIR__, 4).'/modules/ps_emailsubscription/translations'),
                10 => (\dirname(__DIR__, 4).'/modules/ps_socialfollow/translations'),
                11 => (\dirname(__DIR__, 4).'/modules/ps_customeraccountlinks/translations'),
                12 => (\dirname(__DIR__, 4).'/modules/ps_categorytree/translations'),
                13 => (\dirname(__DIR__, 4).'/modules/statsbestmanufacturers/translations'),
                14 => (\dirname(__DIR__, 4).'/modules/statsbestvouchers/translations'),
                15 => (\dirname(__DIR__, 4).'/modules/ps_crossselling/translations'),
                16 => (\dirname(__DIR__, 4).'/modules/klaviyopsautomation/translations'),
                17 => (\dirname(__DIR__, 4).'/modules/statspersonalinfos/translations'),
                18 => (\dirname(__DIR__, 4).'/modules/psassistant/translations'),
                19 => (\dirname(__DIR__, 4).'/modules/psshipping/translations'),
                20 => (\dirname(__DIR__, 4).'/modules/statsbestcustomers/translations'),
                21 => (\dirname(__DIR__, 4).'/modules/statscarrier/translations'),
                22 => (\dirname(__DIR__, 4).'/modules/statssales/translations'),
                23 => (\dirname(__DIR__, 4).'/modules/statsstock/translations'),
                24 => (\dirname(__DIR__, 4).'/modules/statsbestproducts/translations'),
                25 => (\dirname(__DIR__, 4).'/modules/gamification/translations'),
                26 => (\dirname(__DIR__, 4).'/modules/statsregistrations/translations'),
                27 => (\dirname(__DIR__, 4).'/modules/ps_facebook/translations'),
                28 => (\dirname(__DIR__, 4).'/modules/statscatalog/translations'),
                29 => (\dirname(__DIR__, 4).'/modules/ps_metrics/translations'),
                30 => (\dirname(__DIR__, 4).'/modules/ps_checkout/translations'),
                ...
                33 => (\dirname(__DIR__, 4).'/modules/ps_edition_basic/translations'),
                ...
                38 => (\dirname(__DIR__, 4).'/modules/statsproduct/translations'),
                ...
                43 => (\dirname(__DIR__, 4).'/modules/statsforecast/translations'),
                44 => (\dirname(__DIR__, 4).'/modules/dashactivity/translations'),
                45 => (\dirname(__DIR__, 4).'/modules/dashproducts/translations'),
                46 => (\dirname(__DIR__, 4).'/modules/statscheckup/translations'),
                47 => (\dirname(__DIR__, 4).'/modules/ps_brandlist/translations'),
                48 => (\dirname(__DIR__, 4).'/modules/statsdata/translations'),
                49 => (\dirname(__DIR__, 4).'/modules/ps_checkpayment/translations'),
                ...
                53 => (\dirname(__DIR__, 4).'/modules/gsitemap/translations'),
                54 => (\dirname(__DIR__, 4).'/modules/pagesnotfound/translations'),
                55 => (\dirname(__DIR__, 4).'/modules/ps_cashondelivery/translations'),
                56 => (\dirname(__DIR__, 4).'/modules/statsbestcategories/translations'),
                57 => (\dirname(__DIR__, 4).'/modules/psxdesign/translations'),
                58 => (\dirname(__DIR__, 4).'/modules/ps_accounts/translations'),
                59 => (\dirname(__DIR__, 4).'/modules/ps_themecusto/translations'),
                60 => (\dirname(__DIR__, 4).'/modules/ps_wirepayment/translations'),
                61 => (\dirname(__DIR__, 4).'/modules/pscartdropdown/translations'),
                62 => (\dirname(__DIR__, 4).'/modules/ps_mbo/translations'),
                63 => (\dirname(__DIR__, 4).'/modules/mondialrelay/translations'),
                64 => (\dirname(__DIR__, 4).'/modules/poswishlist/translations'),
                65 => (\dirname(__DIR__, 4).'/modules/poscompare/translations'),
                66 => (\dirname(__DIR__, 4).'/modules/posproductcomments/translations'),
                67 => (\dirname(__DIR__, 4).'/modules/posrotatorimg/translations'),
                68 => (\dirname(__DIR__, 4).'/modules/posthemeoptions/translations'),
                69 => (\dirname(__DIR__, 4).'/modules/poscookielaw/translations'),
                70 => (\dirname(__DIR__, 4).'/modules/posfakeorder/translations'),
                71 => (\dirname(__DIR__, 4).'/modules/pospopup/translations'),
                72 => (\dirname(__DIR__, 4).'/modules/posmegamenu/translations'),
                73 => (\dirname(__DIR__, 4).'/modules/posvegamenu/translations'),
                74 => (\dirname(__DIR__, 4).'/modules/posstaticblocks/translations'),
                75 => (\dirname(__DIR__, 4).'/modules/posquickmenu/translations'),
                76 => (\dirname(__DIR__, 4).'/modules/posshoppingcart/translations'),
                77 => (\dirname(__DIR__, 4).'/modules/smartblog/translations'),
                78 => (\dirname(__DIR__, 4).'/modules/smartbloglatestcomments/translations'),
                79 => (\dirname(__DIR__, 4).'/modules/smartblogrecentposts/translations'),
                80 => (\dirname(__DIR__, 4).'/modules/smartblogsearch/translations'),
                81 => (\dirname(__DIR__, 4).'/modules/smartblogtag/translations'),
                82 => (\dirname(__DIR__, 4).'/modules/creativeelements/translations'),
            ],
            ...
            'kernel.secret' => 'L6PgJBEp0XFb4JLnzeFTSaOboymNq8E6D8BOzs4DD4amwLimwj9CqbEP58k6hLzE',
